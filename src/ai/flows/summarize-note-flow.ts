'use server';
/**
 * @fileOverview An AI flow for summarizing notes.
 *
...
const SummarizeNoteInputSchema = z.object({
  ...
  content: z.string().describe('The content of the note to be summarized.'),
});
export type SummarizeNoteInput = z.infer<typeof SummarizeNoteInputSchema>;

const SummarizeNoteOutputSchema = z.object({
  summary: z.string().describe('The concise summary of the note.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert academic assistant. Your task is to summarize the following note clearly and concisely. Focus on the key points and main ideas.
