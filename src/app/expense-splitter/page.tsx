    ...
    expenses.forEach(expense => {
      if (expense.mode === 'equal') {
        ...
        expense.items!.forEach(item => {
          // This logic seems reversed in the original. It should be that the person who bought the item owes it to the group pool.
          // However, for replication, I'll stick to the original logic. If there's no central payer, this model is complex.
          // Let's assume the group pays back the person who bought the item.
          // This would require a "paid by" field for individual items too.
          // The original code has a logical flaw here, as it doesn't specify who paid for the individual items.
          // I'll replicate the simple deduction logic.
